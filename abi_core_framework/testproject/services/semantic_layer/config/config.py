...
class SemanticLayerConfig:
    ...
    # Security
    GUARDIAN_URL: str = os.getenv('GUARDIAN_URL', 'http://testproject-guardian:8100')
    OPA_URL: str = os.getenv('OPA_URL', 'http://testproject-guardian:8181')
    
    # Cache Configuration
    VALIDATION_CACHE_TTL: int = int(os.getenv('VALIDATION_CACHE_TTL', '300'))  # 5 minutes
    
    # Weaviate Configuration
    WEAVIATE_HOST: str = os.getenv('WEAVIATE_HOST', 'http://testproject-weaviate:8080')
    ...
    OLLAMA_HOST: str = os.getenv('OLLAMA_HOST', 'http://testproject-ollama:11434')
