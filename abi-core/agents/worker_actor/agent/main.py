...
from agent.worker_actor import AbiWorkerActor
...
def worker_actor_factory(agent_card_dir: AgentCard):
    ...
    if agent_card.name != "Abi Actor Agent":
    ...
    return AbiWorkerActor()

if __name__ == '__main__':
    start_client("0.0.0.0", 8002, agent_card_dir, worker_actor_factory)
